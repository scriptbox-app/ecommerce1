			...
			@endif
                    ...
                    <div class="product_share">
                        ...
                        <ul class="social_icons">
                            ...
                            <li><a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ rawurldecode(strip_tags(SeoHelper::getDescription())) }}" target="_blank" title="{{ __('Share on Twitter') }}">
